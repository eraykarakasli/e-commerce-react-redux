  ...
  return (
    <div className='flex gap-10 my-10'>
        ...
        <div className=''>
            ...
            <div className='rounded-full bg-gray-200 hover:bg-gray-500 hover:text-white text-2xl border w-[250px] h-16 flex items-center cursor-pointer justify-center'>Sepete Ekle</div>
        </div>
